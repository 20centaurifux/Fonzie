...
typedef enum
{
	...
	OP_CODE_INC           = 5,
	OP_CODE_DEC           = 6,
	OP_CODE_SUB_REG_REG   = 7,
	OP_CODE_SUB_REG_ADDR  = 8,
	OP_CODE_SUB_REG_DWORD = 9,
	OP_CODE_ADD_REG_REG   = 10,
	OP_CODE_ADD_REG_ADDR  = 11,
	OP_CODE_ADD_REG_DWORD = 12,
	OP_CODE_MUL_REG_REG   = 13,
	OP_CODE_MUL_REG_ADDR  = 14,
	OP_CODE_MUL_REG_DWORD = 15,
	OP_CODE_DIV_REG_REG   = 16,
	OP_CODE_DIV_REG_ADDR  = 17,
	OP_CODE_DIV_REG_DWORD = 18,
	OP_CODE_RET           = 19,
	OP_CODE_CMP_REG_ADDR  = 20,
	OP_CODE_CMP_REG_REG   = 21,
	OP_CODE_JE            = 22,
	OP_CODE_JNE           = 23,
	OP_CODE_JGE           = 24,
	OP_CODE_JG            = 25,
